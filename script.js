...
const birthdayLetterMessage = [
  ...
  "Selamat ulang tahun.",
  "",
  "Aku tidak punya hadiah yang besar,jadi untuk sekarang anggap saja halaman kecil ini sebagai salah satunya.",
  "",
  ...
  "",
  "Tetap jadi dirimu yang sekarang yaa. Tetap tumbuh dengan caramu sendiri. Tidak perlu terburu-buru menjadi apa pun.",
  "",
